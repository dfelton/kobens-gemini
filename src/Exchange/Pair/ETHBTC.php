...
use Kobens\Currency\Crypto\{Bitcoin, Ethereum};

class ETHBTC extends Pair implements PairInterface
{
    const MIN_ORDER_SIZE = '0.001';
    const MIN_ORDER_INCREMENT = '0.000001';
    const MIN_PRICE_INCREMENT = '0.00001';

    public function __construct()
    {
        parent::__construct(new Ethereum(), new Bitcoin());
    }
