...
CREATE TABLE `gemini_trade_history` (
    ...
    `timestamp` BIGINT(10) UNSIGNED NOT NULL COMMENT 'Timestamp',
    ...
    `client_order_id` VARCHAR(100) DEFAULT NULL COMMENT 'Client Order Id',
    `exchange` VARCHAR(25) DEFAULT NULL COMMENT 'Exchange',
    `is_auction_fill` TINYINT(1) NOT NULL COMMENT 'Is Auction Fill',
